...
### - JSON devuelto después de actualizar:

<img width="1362" height="668" alt="image" src="https://github.com/user-attachments/assets/681adc42-9b70-4227-92cd-fefcca221603" />

### - Comprobación en base de datos, de que el registro fue actualizado:
```
select * from public.menus order by id asc
```

<img width="1503" height="494" alt="image" src="https://github.com/user-attachments/assets/4d2539d0-cabc-4594-8cfb-4097370c7a2a" />

# NOTA: Verificar que la imagen anterior del registro, se elimine de la carpeta "uploads/menus/", y se haya actualizado con la nueva imagen agregada.
# ¡Listo! Ahora ya se permite actualizar registros dentro de la base de datos.
